...
<div class="col-xl-3 col-md-6 mb-4">
    <div class="stats-widget">
        <div class="d-flex justify-content-between align-items-start">
            <div>
                <div class="stat-number">₹{{ number_format($stats['earnings_this_month']) }}</div>
        ...
        <div class="mt-3">
            <small class="text-success">
                <i class="bi bi-arrow-up me-1"></i>₹{{ number_format($stats['total_earnings']) }} total
            </small>
        </div>
    </div>
</div>
    ...
    <div class="stats-widget">
        ...
        <div class="mt-3">
            <small class="text-muted">
                <i class="bi bi-star-fill me-1"></i>{{ $stats['completed_sessions'] }} reviews
            </small>
        </div>
    </div>
</div>
...
<div class="col-xl-3 col-md-6 mb-4">
    <div class="stats-widget">
        <div class="d-flex justify-content-between align-items-start">
            <div>
                <div class="stat-number">{{ number_format($stats['institutes_associated']) }}</div>
...
<div class="col-xl-3 col-md-6 mb-4">
    <div class="stats-widget">
        <div class="d-flex justify-content-between align-items-start">
            <div>
                <div class="stat-number">{{ number_format($stats['upcoming_sessions']) }}</div>
...
<div class="col-xl-3 col-md-6 mb-4">
    <div class="stats-widget">
        <div class="d-flex justify-content-between align-items-start">
            <div>
                <div class="stat-number">{{ number_format($stats['completed_sessions']) }}</div>
        ...
        <div class="mt-3">
            <small class="text-success">
                <i class="bi bi-graph-up me-1"></i>{{ number_format(($stats['completed_sessions'] / max($stats['total_sessions'], 1)) * 100, 1) }}% completion
            </small>
        </div>
    </div>
</div> 